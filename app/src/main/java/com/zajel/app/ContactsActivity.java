...
public final class ContactsActivity extends Activity {
    ...
    private void invite(ContactEntry contact) { Intent share = new Intent(Intent.ACTION_SEND); share.setType("text/plain"); share.putExtra(Intent.EXTRA_TEXT, "انضم إلى Zajel للتواصل بأمان: https://github.com/sinaigold9-jpg/Zagle"); startActivity(Intent.createChooser(share, "إرسال دعوة")); }
}
